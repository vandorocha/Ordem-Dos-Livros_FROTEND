<script>
    import {IconBooks, IconFriends, IconHome, IconUsers, IconSquare1, IconSquare2, IconSquare3, IconSquare4, IconRss, IconBrandFacebook, IconBrandInstagram, IconBrandYoutube} from "@tabler/icons-svelte"
    import Menu from "./Menu.svelte";
    import MenuItem from "./MenuItem.svelte";

</script>
<aside class="flex flex-col w-72 self-start gap-10 
